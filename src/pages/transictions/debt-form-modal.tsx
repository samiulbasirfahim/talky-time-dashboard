...
type DebtFormFieldErrors = Partial<Record<"operatorDbId" | "reason" | "amount" | "issueDate", string>>;
...
export function DebtFormModal({
    ...
    const [formValues, setFormValues] = React.useState<DebtFormValues>(EMPTY_FORM);
    const [operatorSearch, setOperatorSearch] = React.useState("");
    const [fieldErrors, setFieldErrors] = React.useState<DebtFormFieldErrors>({});
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const nextErrors: DebtFormFieldErrors = {};
    ...
    const primaryLabel = defaultValues ? "Save" : "Create Debt";
    ...
    return (
        <FormModalShell
            ...
            title="Debts"
            description="Manage operator debts and adjustments."
            submitLabel={isSubmitting ? `${primaryLabel}...` : primaryLabel}
            ariaLabel="Debts form"
